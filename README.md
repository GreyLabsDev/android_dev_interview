...
## Как выглядит воронка Senior Android в 2026
...
Российский рынок (Яндекс, Авито, Ozon, Сбер и т. п.):
...
- KMP из экзотики стал требованием во многих вакансиях (в России — особенно, вместе с Compose Multiplatform, Decompose, Ktor, SQLDelight).
- Появился блок про on-device AI (Gemini Nano / ML Kit GenAI) и про то, как вы используете AI-инструменты в работе.
- Глубина важнее ширины: интервьюер даёт 2–3 уровня follow-up на каждый ответ и смотрит, где вы «сдуетесь».

## Требования рынка (Россия, лето 2026)

По открытым вакансиям Senior Android: опыт от 5 лет. Вилки на руки по агрегаторам (hh.ru,
Habr Career): Москва 270 000 – 450 000 ₽, Петербург 250 000 – 400 000 ₽, регионы-миллионники
220 000 – 350 000 ₽; финтех на Kotlin + Compose доходит до 550 000 ₽, Tech Lead / Staff —
400 000 – 700 000 ₽. Медиана по мобильной разработке — около 320 000 ₽. Цифры выше 600 000 ₽
для чистого Senior — это либо лид-роль, либо релокация, либо аутстафф на зарубежного заказчика:
не закладывайте их как ориентир в переговорах, но и не занижайте себя ниже 270 000 ₽ в Москве.

Обязательный стек почти везде: Kotlin (корутины + Flow на уверенном уровне), Jetpack Compose,
MVVM/MVI, Hilt или Koin, Retrofit/Ktor + OkHttp, Room, offline-first, WorkManager.
Всё чаще: Kotlin Multiplatform и Compose Multiplatform, самостоятельные релизы в сторы,
модуляризация и оптимизация сборки.

## Платформенные дедлайны, о которых спросят
